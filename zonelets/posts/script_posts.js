...
<div class="navbar">
  ...
  <a class="link-wrapper" href="../../index.html">
    ...
    <div class="img-wrapper">
      <img class="normal" src="./menu/homenormal.png">
      <img class="active" src="./menu/homeactive.png">
    </div>
...
<polygon fill="#00FFFF" points="14,0.5 127.4,0 77.4,164 2.3,61.1 "/>
  ...
  <a class="link-wrapper" href="/zonelets/about.html">
    ...
    <div class="img-wrapper">
      <img class="normal" src="./menu/aboutnormal.png">
      <img class="active" src="./menu/aboutactive.png">
    </div>
    <div class="shape-wrapper">
      <div class="shape red-fill jelly"><svg x="0px" y="0px"
     viewBox="0 0 108.1 47" enable-background="new 0 0 108.1 47">
...
<polygon fill="#00FFFF" points="11,3,85.1,0 118.8,45.6,14.3,29 "/>
  ...
  <a class="link-wrapper" href="/zonelets/blog.html">
    ...
    <div class="img-wrapper">
      <img class="normal" src="./menu/blognormal.png">
      <img class="active" src="./menu/blogactive.png">
    </div>
    <div class="shape-wrapper">
      <div class="shape red-fill jelly"><svg x="0px" y="0px"
     viewBox="0 0 108.1 47" enable-background="new 0 0 108.1 47">
...
<polygon fill="#00FFFF" points="14,0.5 127.4,0 77.4,164 2.3,61.1 "/>
  ...
  <a class="link-wrapper" href="../../index_page.html">
    ...
    <div class="img-wrapper">
      <img class="normal" src="./menu/indexnormal.png">
      <img class="active" src="./menu/indexactive.png">
    </div>
    <div class="shape-wrapper">
      <div class="shape red-fill jelly"><svg x="0px" y="0px"
     viewBox="0 0 108.1 47" enable-background="new 0 0 108.1 47">
...
<polygon fill="#00FFFF" points="0.3,17 125.1,0 68.8,45.6 24.3,39 "/>
  ...
  <a class="link-wrapper" href="../archive.html">
    ...
    <div class="img-wrapper">
      <img class="normal" src="./menu/archivenormal.png">
      <img class="active" src="./menu/archiveactive.png">
    </div>
    <div class="shape-wrapper">
      <div class="shape red-fill jelly"><svg x="0px" y="0px"
     viewBox="0 0 108.1 47" enable-background="new 0 0 108.1 47">
...
<polygon fill="#00FFFF" points="17.3,0 105.1,0 68.8,45.6 24.3,39 "/>
  ...
  <a class="link-wrapper" href="../../credits.html">
    ...
    <div class="img-wrapper">
      <img class="normal" src="./menu/creditsnormal.png">
      <img class="active" src="./menu/creditsactive.png">
    </div>
<div class="shape-wrapper">
      <div class="shape red-fill jelly"><svg x="0px" y="0px"
     viewBox="0 0 108.1 47" enable-background="new 0 0 108.1 47">
